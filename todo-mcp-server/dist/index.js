...
async function runHTTP() {
    ...
    app.get('/api/projects/:id', (req, res) => {
        try {
            res.json(projectService.getById(parseInt(req.params.id, 10)));
        }
        catch (e) {
            const err = e;
            res.status(err.statusCode || 400).json({ error: err.message });
    ...
    app.put('/api/projects/:id', (req, res) => {
        try {
            res.json(projectService.update(parseInt(req.params.id, 10), req.body));
        }
        catch (e) {
            const err = e;
            res.status(err.statusCode || 400).json({ error: err.message });
    ...
    app.get('/api/projects/:id/milestones', (req, res) => {
        try {
            res.json(projectService.getMilestones(parseInt(req.params.id, 10)));
        }
        catch (e) {
            const err = e;
            res.status(err.statusCode || 400).json({ error: err.message });
    ...
    app.post('/api/milestones', (req, res) => {
        try {
            res.status(201).json(projectService.createMilestone(req.body));
        }
        catch (e) {
            const err = e;
            res.status(err.statusCode || 400).json({ error: err.message });
    ...
    app.get('/api/todos', (_req, res) => {
        const { status, project_id, standalone } = _req.query;
        if (standalone === 'true') {
            res.json(todoService.getStandalone({ status }));
            return;
        }
    ...
    app.post('/api/todos', (req, res) => {
        try {
            res.status(201).json(todoService.create(req.body));
        }
        catch (e) {
            const err = e;
            res.status(err.statusCode || 400).json({ error: err.message });
    ...
    app.put('/api/todos/:id', (req, res) => {
        try {
            res.json(todoService.update(parseInt(req.params.id, 10), req.body));
        }
        catch (e) {
            const err = e;
            res.status(err.statusCode || 400).json({ error: err.message });
    ...
    app.delete('/api/todos/:id', (req, res) => {
        try {
            res.json(todoService.delete(parseInt(req.params.id, 10)));
        }
        catch (e) {
            const err = e;
            res.status(err.statusCode || 400).json({ error: err.message });
    ...
    app.patch('/api/todos/:id/status', (req, res) => {
        try {
            res.json(todoService.updateStatus(parseInt(req.params.id, 10), req.body.status));
        }
        catch (e) {
            const err = e;
            res.status(err.statusCode || 400).json({ error: err.message });
    ...
    app.get('/api/projects/:id/tree', (req, res) => {
        try {
            res.json(todoService.getProjectTree(parseInt(req.params.id, 10)));
        }
        catch (e) {
            const err = e;
            res.status(err.statusCode || 400).json({ error: err.message });
